...
//     if (!email) {
//       return alert("⚠️ Please enter your email.");
//     }
...
//       setOtpSent(true); // Disable email input and show OTP fields
  
//       // Store the OTP token in state
//       setOtpToken(response.data.otpToken);  // Store the OTP token here
//     } catch (err) {
...
//         otp: otp,
//         otpToken: otpToken, // Send the otpToken here
//       });
...
//       alert(error.response?.data?.msg || "❌ Failed to verify OTP");
//     }
//   };
...
//     if (!isOtpVerified) {
//       return alert("⚠️ Please verify your OTP before proceeding.");
//     }
...
//               disabled={otpSent} // Disable the email field once OTP is sent
//             />
//             {!otpSent && (
//               <button
//                 onClick={sendOtp}
//                 className="ml-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition duration-300"
//               >
//                 Send OTP
//               </button>
//             )}
...
//           <div className="mb-4">
//             <label className="block text-sm font-semibold text-gray-600 mb-1">Enter OTP</label>
//             <input
//               type="text"
//               value={otp}
...
//             <button
//               onClick={verifyOtp}
//               className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 mt-2"
//             >
//               Verify OTP
//             </button>
//           </div>
...
//             disabled={!isOtpVerified} // Disable password fields until OTP is verified
//           />
//         </div>
