...
// const notificationSound = new Audio('/sounds/notification.mp3'); // public path
...
//         // setMessages((prev) => ({
//         //   ...prev,
//         //   [activeUser._id]: response.data,
//         // }));
//         setMessages((prev) => {
//   const previousMessages = prev[activeUser._id] || [];
//   const fetchedMessages = response.data || [];

//   // Merge and remove duplicates based on timestamp + content + file name
...
//     // Optionally play ringtone, open modal with Accept/Reject
//   });
...
// const isNewConversation = (userId) => {
//   return !messages[userId] || messages[userId].length === 0;
// };
...
//       // You can now merge them or show separately
//       setSelectedUsers(chattedUsers); // Already chatted
//       setAvailableUsers(allUsers);    // All available users to start new chat
//     } catch (err) {
...
//           <h2 className="text-lg font-semibold mb-2">Chat Info</h2>
//           {selectedUsers.length > 0 ? (
//             <ul className="space-y-1 text-sm">
//              {selectedUsers.map((u, index) => {
//   // const userMessages = messages[u._id] || [];
//   // const lastMessage = userMessages && userMessages.length > 0
...
//       className={`cursor-pointer p-2 rounded hover:bg-purple-200 ${activeUser?._id === u._id ? 'bg-purple-300 font-semibold' : ''}`}
//       onClick={() => handleUserSelect(u)}
//     >
//       <div className="flex justify-between items-center">
//         <div>
//           <div className="font-medium"> {u.username || "Unnamed User"}</div>
// {/* <div className="flex justify-between items-center text-xs text-gray-400">
//   <span 
//   title={lastMessage?.content || lastMessage?.file?.name || ''} className="truncate max-w-[150px]">
//     {lastMessage?.content
//       ? lastMessage.content
//       : lastMessage?.file
//       ? `[File] ${lastMessage.file.name}`
//       : ''}
//   </span>
...
//   {/* Last message or file name */}
//   <span className="block truncate max-w-[160px]" title={
...
//   {/* Time */}
//   <span className="ml-2 min-w-fit text-nowrap">
//     {lastMessage?.timestamp
//       ? new Date(lastMessage.timestamp).toLocaleTimeString([], {
//           hour: '2-digit',
//           minute: '2-digit',
...
//         </div>
//   {unreadCounts[u._id] > 0 && activeUser?._id !== u._id && (
//   <div className="bg-red-500 text-white rounded-full px-2 text-xs">
//     {unreadCounts[u._id]}
//   </div>
// )}
...
//             </ul>
//           ) : (
//             <p className="text-sm text-gray-600">No users selected.</p>
//           )}
//         </div>
...
//               <h2 className="text-2xl text-gray-600">Welcome to Konvo</h2>
//             </div>
//           ) : !hasUserActivatedChat && activeUser._id === promptUserId ? (
//             <div className="flex justify-center items-center h-full">
//               <p className="text-lg text-gray-600">Click again to start the conversation</p>
//             </div>
//           ) : (
//             <>
//               {/* Chat Header */}
//                <ToastContainer position="top-right" autoClose={3000} />
//               <div className="bg-purple-600 text-white px-4 py-2 rounded-t-md text-lg font-semibold flex justify-between items-center">
//   {/* Left: username and typing */}
 

//   <div className="flex flex-col">
//     <span>{activeUser.username}</span>
//     {typingUser && (
//       <span className="text-sm italic text-white/80">typing...</span>
//     )}
//   </div>

//   {/* Right: join input and button */}
//   <div className="flex items-center space-x-2">
    
 
//     {activeUser && user && user._id !== activeUser._id && (
//   <button onClick={() => handleCallUser(activeUser)}>
//     Call {activeUser.username}
//   </button>
// )}
...
//               {/* Messages Area */}
//               <div className="flex-1 bg-gray-100 p-4 rounded-b-md overflow-y-auto" style={{ maxHeight: 'calc(100vh - 250px)' }}>
...
//   const isImage = msg.file?.type?.startsWith('image/'); // Check for image type
...
//           isSender ? 'bg-purple-500 text-white' : 'bg-gray-300 text-black'
//         }`}
//       >
...
//               {/* Message Input */}
//               <form onSubmit={handleSendMessage} className="flex items-center mt-4 border-t pt-4">
//                 <input
//                   type="text"
...
//   <label htmlFor="file-upload" className="ml-2 mb-2 cursor-pointer">
//     <span className="text-xl ml-1  px-3 py-2 bg-gray-300  rounded hover:bg-gray-400">📎</span>
//   </label>
//   <input
//     id="file-upload"
//     type="file"
...
//               {uploadingFile && (
//                 <div className="mt-2">
//                   <div className="text-sm text-gray-600">{uploadingFile.name}</div>
//                   <div className="w-full bg-gray-200 h-2 rounded mt-1">
//                     <div className="bg-purple-600 h-2 rounded" style={{ width: `${fileProgress}%` }} />
//                   </div>
//                 </div>
//               )}
...
//                   <EmojiPicker onEmojiClick={(emojiData) => handleEmojiSelect(emojiData)} emojiStyle="native" />
//                 </div>
//               )}
//                 {/* File Upload Progress */}
//                 {uploadingFile && (
//                 <div className="mt-2 text-sm text-gray-600">
//                   Uploading {uploadingFile.name}... {fileProgress}%
...
// {incomingCall && (
//   <div className="fixed top-10 right-10 p-4 bg-white border rounded shadow-lg z-50">
